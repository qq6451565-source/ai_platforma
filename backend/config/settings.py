...
FACE_ATTENDANCE_MIN_SAMPLES = int(os.getenv("FACE_ATTENDANCE_MIN_SAMPLES", "6"))
FACE_ATTENDANCE_PRESENT_RATIO = float(os.getenv("FACE_ATTENDANCE_PRESENT_RATIO", "0.70"))
