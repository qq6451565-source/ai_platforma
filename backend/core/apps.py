...
class CoreConfig(AppConfig):
    ...
    def ready(self):
        ...
        from university.models import Campus, Faculty, Department, Degree, StudyMode
        from semesters.models import SemesterSettings
        ...
        auditlog.register(SemesterSettings)
