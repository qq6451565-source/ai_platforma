...
export const ADMIN_QUERY_KEYS = {
  ...
  chatMessages: ["admin-chat"] as const,
  ...
  liveMonitoring: (roomName?: string) => ["live-monitoring", roomName] as const,
  ...
  testQuestions: ["admin-test-questions"] as const,
  testOptions: ["admin-test-options"] as const,
